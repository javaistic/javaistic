...
---
**Javaistic** is an **Open Source** Java program learning site that help students to learn **Java** programing.
...
<p className="flex h-6">
  <img
    alt="stars"
    src="https://badgen.net/github/stars/uiuxarghya/javaistic"
    className="inline-block mr-2"
  />
  <img
    alt="license"
    src="https://badgen.net/github/license/uiuxarghya/javaistic"
    className="inline-block mr-2"
  />
</p>
...
Feel free to join the [discussions on GitHub](https://github.com/uiuxarghya/javaistic/discussions)!
