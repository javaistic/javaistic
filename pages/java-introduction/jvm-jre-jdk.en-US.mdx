...
<div className="mt-8" />
<div align="center">
<img className="flex-shrink" src="/img/intro/1/1.svg" />
...
<div className="mt-8"/>
<div align="center">
<img className="flex-shrink" src="/img/intro/1/2.svg" />
...
<div className="mt-8" />
<div align="center">
  <img className="flex-shrink" src="/img/intro/1/3.svg" />
...
<div className="mt-8" />
<div align="center">
  <img className="flex-shrink" src="/img/intro/1/4.svg" />
  **Relationship between JVM, JRE, and JDK**
</div>
