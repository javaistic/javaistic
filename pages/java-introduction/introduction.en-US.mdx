...
To get started with Java programming, visit [Java Tutorials](/java-introduction/introduction).
...
- **Learn Java language the right way** : If you are switching from another programming language (let's say C#), don't write C# style code in Java. Also, check this article on [How to write good Java code?](http://www.ibm.com/developerworks/library/j-perry-writing-good-java-code/index.html)
