export function TipGood({ children }) {
  return (
    <p className="mt-8 mb-4 flex items-start space-x-2">
      ...
      <strong className="flex-1 text-base font-semibold leading-7 text-gray-900">{children}</strong>
    </p>
  )
}
...
export function TipInfo({ children }) {
  return (
    <div className="mb-8 rounded-lg bg-blue-50 px-6 py-4 text-sm leading-6 text-blue-800 dark:bg-blue-900">
      <div className="flex items-start space-x-3">
