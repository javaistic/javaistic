        ...
        <div className="flex flex-col gap-12 lg:flex-row">
          ...
          >
            <div className="sticky top-8">
              <motion.div className="rounded-2xl border border-neutral-200 bg-white/80 p-6 shadow-2xl shadow-lg backdrop-blur-sm transition-colors duration-300 dark:border-neutral-700/50 dark:bg-neutral-900/70">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="rounded-2xl border border-neutral-200 bg-white/80 p-6 shadow-2xl shadow-lg backdrop-blur-sm transition-colors duration-300 dark:border-neutral-700/50 dark:bg-neutral-900/70">
              {/* Introduction */}
