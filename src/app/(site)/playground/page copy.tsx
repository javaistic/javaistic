  ...
  return (
    <>
      <div className="m-8 space-y-4">
        <h1 className="font-funnel-display mx-auto mb-6 max-w-3xl text-center text-3xl font-extrabold tracking-tight text-neutral-900 sm:text-5xl dark:text-white">
          Javaistic{" "}
