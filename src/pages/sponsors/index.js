          ...
          <div className="container px-2 py-10 mx-auto flex flex-wrap">
            <div className="flex flex-wrap">
              <div className="p-4 lg:w-1/2 md:w-full">
                <div className="flex border-2 rounded-xl bg-white shadow-md hover:shadow-xl border-gray-300 border-opacity-50 p-8 sm:flex-row flex-col">
                  <div className="w-24 h-24 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center text-black flex-shrink-0">
                    <svg
                      width="4438"
                      height="1000"
              ...
              <div className="p-4 lg:w-1/2 md:w-full">
                <div className="flex border-2 rounded-xl bg-white shadow-md hover:shadow-xl border-gray-300 border-opacity-50 p-8 sm:flex-row flex-col">
                  <div className="w-28 h-28 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full text-black flex-shrink-0">
                    <svg
                      width="169"
                      height="36"
                      viewBox="0 0 169 36"
              ...
              <div className="p-4 lg:w-1/2 md:w-full">
                <div className="flex border-2 rounded-xl bg-gray-100 shadow-inner border-gray-300 border-opacity-50 p-8 sm:flex-row flex-col">
                  <div className="w-28 h-28 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full hover:bg-gray-200 border-4 border-gray-300 border-dashed text-gray-300 flex-shrink-0">
