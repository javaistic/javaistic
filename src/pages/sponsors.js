  ...
  return (
    <>
      <Head>
        ...
        <title>Sponsors - Javaistic</title>
      </Head>
      <div className="px-10 pt-10 pb-16 sm:px-10 md:px-12">
        <h1 className="mt-5 mb-4 text-center text-6xl font-extrabold text-gray-900">
          Support Javaistic 💖
        </h1>
        <div className="mb-2 items-center justify-center space-y-5 text-center">
          <p className="mx-auto text-lg font-medium text-gray-500 dark:text-gray-400 sm:w-1/2">
            Our maintainers devote their time, effort, and heart to ensure Javaistic keeps getting
            better. Support us by donating to our collective 🙏
          </p>
        </div>
        <section className="text-gray-600">
          <div className="container mx-auto space-y-8 py-10">
            <div className="mx-auto flex flex-col items-start rounded-xl border-2 border-gray-200 bg-white p-8 shadow-md dark:border-gray-700 dark:bg-gray-800 sm:flex-row sm:items-center lg:w-3/5">
              <div className="pr-8">
                <svg viewBox="0 0 32 32" focusable="false" className="h-20 w-auto">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
              ...
              <div className="flex-grow text-gray-900 sm:pr-16">
                <h1 className="text-2xl font-bold ">Open Collective</h1>
              ...
              <button
                ...
                onClick={() => router.push('https://opencollective.com/javaistic')}
              >
                Sponsor
              </button>
            </div>
            <div className="mx-auto flex flex-col items-start rounded-xl border-2 border-gray-200 bg-white p-8 shadow-md dark:border-gray-700 dark:bg-gray-800 sm:flex-row sm:items-center lg:w-3/5">
              <div className="pr-8">
                ...
                >
                  <path
                    d="M1051 947c-62-26-282 92-432 106s-252 14-304 46-60 38-74 80 336 112 336 112l564 236s380 86 360-6-78-142-138-304l-40-184z"
                    fill="#261e2b"
                  />
                  <path
                    d="m1299.7 1083 9.7-54.3L1051 947c-28.9-12.1-92.1 7-166.6 32.4 33.2 5.5 75.8 24.3 81.2 61 .3 2-9.3 22-28 45.3 0 0-66.1-69.9-129.7-80.1-1.7.6-3.4 1.1-5.1 1.7l-56.6 87.8 102 124.7 158 43.3 219.3-76.7zm-852.8-15.5c-17.1 1.7-32.9 3.6-47.5 5.8 3.5 5.6-1 17.5-8 29.2-9.5 16-33 31-35 59s20 51.5 51 67c21.4 10.7 52.3 29.7 69.4 40.5 3.9.9 7.7 1.8 11.5 2.7zm993.3 315.5-168.2-19-52 87 23 52c50-21 87.5-13.5 101-11.5s48 12 60.5-10 7.1-11.5 11.6-21.5 14.5-20.5 35-17c11.7 2 26.4 13.4 32 22-10.3-21.8-29.1-57-42.9-82z"
                    fill="#19121d"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1619.5 493.7c-.3-2.2-.7-4.7-1.2-7.3.1 2.3.5 4.8 1.2 7.3zm60.1 263.4c33.8-105.9 21.2-190.2 1.2-248.4-13.2 17.7-22.5 19-35.8 15-11.2-3.4-22-16.7-25.5-30 2.8 18.4 2.8 25.1 7.5 72.7 5.3 53.3-5.3 124-28 183.3s-54.7 103.3-58 128.7-29.3 70.7-29.3 70.7l-46.1 72.9c76.2-33 159.9-95.7 214-264.9z"
                    fill="#19121d"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M833.7 784.3c-4-32 3-36.7-19.6-64.7-20.6-25.6-28.5-99-26.7-208.4-3.1 11.8-5.7 23.7-7.8 35.9-19.5 111 10.5 259.5 66 324 10.1 11.7 21.4 22.8 33.8 33.3z"
                    fill="#19121d"
                  />
                  <path
                    d="M805.1 731.6c-28.5-34.5-162.1-88.8-171-33-6 37.5 123.4 7.4 166.9 46.4zm675-430.5c34.5-36 192-60 243-28.5s-6 247.5-58.5 286.5zm-375-72c-33-94.5-185-148.6-215-130.6-22.5 13.5-118 193.6-52 304.6zm483 648c39-4.5 181.5 13.5 160.5 55.5s-96-37.5-154.5-33c0 0-10.5-24-6-22.5zm-13.5 51c-10.1-4.2 4.5-13.5 19.5-10.5s130 51.9 94.5 84c-31.5 28.5-67.5-54-114-73.5z"
                    fill="#261e2b"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1525.2 935.3c-34.3 58.7-59.7 77.7-87.2 79.7-14 1-38 2-38 2-18-26-169-64-169-64s-179 10-192 16c-61.2-13.5-158-69.9-200.1-113.1 3.3 7 7.2 14 11.7 20.9 55.8 61.4 144.1 104.7 264.9 135.3 124.5 31.5 258 46.5 337.5 15 1.6-.7 3.3-1.3 5-2 41.6-23.5 55.3-56.5 67-89.5.1-.1.1-.2.2-.3zm-3.4-61.1c0-1 .1-2 .3-3.1 3-25.5 40.5-75 63-117s34.5-81 6-156-103.5-85.5-141-75-91.5 48-196.5 36-145.5-84-220.5-111-133.5-6-168 76.5 4.5 168 0 183c-.9 2.9-2.3 5.2-4.2 7.3 42.2-6.5 101.5 14.3 116.1 36.7 22-2.7 46 4.7 58.7 14s27.3 21.3 36.7 31.3c9.3 10 52.1-15.1 121.4 5.5 69.3 20.7 83.2 50.5 102.6 47.8 19.3-2.7 35.3-25.3 66-21.3s30.8 12.6 47.3 10.7c14.3-1.6 73.3-4.6 112.1 34.6z"
                    fill="#ffc7a5"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1319.6 830.1c.5 1.7 1 3.3 1.5 5 0 0 12.2-1 24.1-3.9-13.2 1.2-21 .3-25.6-1.1zm109.5-173.5c-27-28.5-83.8-9.7-103.6 32l.2.3c29.3-23.3 64.7-42.7 89.3-23.3 24.7 19.3 20 73.3 7.3 102.7-12.1 28-10.8 50.5-53.6 59.5 6.3 1.2 13 4 22.9 7.3 0 0 10.5-12 22.5-30 37.5-73.5 43.5-118.5 15-148.5z"
                    fill="#c1d9d5"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1076 732.5c-.2 22-11.1 50.8-48.5 29l31.1 19.6L1078 746zm17.1-86.4c-7.5-51-36-94.5-72-85.5-29.9 7.5-53.6 48-47.9 118.3 3.3-40 8.7-69 25.8-87.9 18.7-20.7 46-21.3 67.3 9.3 21.3 30.7 28 63.3 25.3 92.7l.8-2c2.3-14.7 2.9-29.8.7-44.9z"
                    fill="#c1d9d5"
                  />
                  <path
                    d="M1093.1 646.1c-3-12.6-6.8-24.9-12.1-36.4s-11.8-22.5-20.4-31.2c-2.1-2.2-4.4-4.2-6.8-6-1.2-.9-2.4-1.7-3.7-2.5-.6-.4-1.3-.7-1.9-1.1l-1-.5-1-.5c-2.6-1.3-5.3-2.2-8.1-2.9-.7-.1-1.4-.3-2.1-.4l-2.1-.3c-.7-.1-1.4-.1-2.1-.1h-1.1l-1.1.1c-5.6.2-11.2 1.9-16.3 4.6-5 2.8-9.6 6.5-13.5 11s-7.2 9.6-10 15-5 11.2-6.9 17.1-3.2 12-4.3 18.2-1.8 12.5-2.3 18.8c-1 12.6-.8 25.4 0 38.2.7 12.8 2.3 25.6 4.1 38.4-3.9-12.3-6.8-25-9-37.9-2-12.9-3.2-25.9-3-39.1 0-3.3.2-6.6.4-9.9.1-1.6.3-3.3.4-4.9s.3-3.3.6-4.9c.8-6.6 2.1-13.1 3.9-19.6 1.8-6.4 4.1-12.8 7.1-18.9s6.7-11.9 11.3-17.2c4.6-5.2 10.1-9.8 16.4-13.2l2.4-1.2 1.2-.6 1.3-.5 2.5-.9 2.6-.7c.9-.3 1.7-.4 2.6-.6s1.8-.4 2.7-.5l2.7-.3c.9-.1 1.8-.1 2.7-.1h1.4c.5 0 .9.1 1.4.1.9.1 1.8.1 2.7.2l2.7.4c.9.1 1.8.4 2.6.6 3.5.9 6.9 2.2 10 4l1.2.6 1.1.7c.7.5 1.5.9 2.2 1.4 1.4 1 2.9 2 4.2 3.2 2.7 2.2 5.1 4.7 7.4 7.2 8.9 10.3 14.9 22.4 19.2 34.8 4.4 12.5 7 25.4 7.8 38.3z"
                    fill="#8f564a"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1309.7 847c2.4-3.4 5.6-6.2 9.1-8.6s7.2-4.3 11.1-5.9c7.8-3.2 16.1-5.1 24.4-5.8 8.4-.7 16.9-.2 25.1 1.9 4.1 1.1 8.1 2.6 11.8 4.6 3.7 2.1 7.1 4.6 9.8 7.8-7-4.3-14.7-6.6-22.5-7.8s-15.8-1.2-23.7-.5-15.7 2.1-23.4 4.2c-3.8 1.1-7.6 2.4-11.2 4-3.7 1.7-7.2 3.7-10.5 6.1zM1064 795c-2.2-3.6-4.9-6.7-7.8-9.6s-6-5.5-9.2-8c-6.4-5-13.4-9.3-20.6-13s-14.8-6.7-22.6-8.5-16-2.4-24.2-.2c3.6-2.3 7.7-3.7 12-4.4s8.7-.6 13-.1c8.6 1 16.9 3.9 24.5 7.8s14.7 8.9 20.9 14.8c3.1 3 5.9 6.2 8.4 9.7 2.5 3.6 4.6 7.4 5.6 11.5z"
                    fill="#e3956f"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M1351.7 705.2v8c1.8 0 3.6.3 5.2.8 6.7 2.2 11.9 8.6 14.6 18 3 10.7 2.4 23.5-1.6 36.3-6.8 21.4-22.6 37.5-36.8 37.5-1.8 0-3.6-.3-5.2-.8-14.9-4.8-20.9-29.6-13-54.3 6.8-21.4 22.6-37.5 36.8-37.5zm0 0c-17.5 0-36.3 17.5-44.4 43.1-9.4 29.3-1.2 58.2 18.2 64.3 2.5.8 5.1 1.2 7.7 1.2 17.5 0 36.3-17.5 44.4-43.1 9.4-29.3 1.2-58.2-18.2-64.3-2.6-.8-5.1-1.2-7.7-1.2z"
                    fill="#8e4637"
                  />
                  <ellipse
                    cx="1341.3"
                  ...
                  />
                  <path
                    d="M1399 1472c-13 22-56 9-98 14s-107 49-132 91-28 66-16 71 28-6 29-13c-2 34 82 67 127 73s140-20 179-87 12-125-24-193zM321 1096c-83 36-102 99-94 183s111 181 215 145c0 27 18 26 26 25s20-16 25-34 10-83-10-124-110-77-109-105 5-40 5-40-34-64-58-50z"
                    fill="#261e2b"
                  />
                  <path
                    d="M655.7 989.4c-15.9-22.8-77.2-19-132.5 19.6s-83.9 97.4-68 120.1c15.9 22.8 73.6 9.9 129-28.7 55.3-38.4 87.3-88.2 71.5-111zm440.4 67.7c28.1-20 39.5-46.7 30-60s-39.4-5-67.5 15-47 51.2-37.5 64.5 46.9.5 75-19.5z"
                    fill="#f692ce"
                  />
                  <g fill="#19121d">
                    <path d="M467 1401c-14.7-2-20-31.3-14.7-46.7-4 6.7-34 44.7-125.3 4.7-78.2-34.2-94.8-89.5-97.6-154.5-4.1 20.5-5.3 45-2.4 74.5 8 84 111 181 215 145 0 27 18 26 26 25s20-16 25-34c4.6-16.6 9.2-73-5.7-113.9 13.5 89.8-6 101.9-20.3 99.9zm1021 220c21.1-36.3 20.2-77.6 8.2-116.3-2.3-7.6-16.3-41.5-16.2-33.6.7 30.8-6.4 94.6-46.5 130.5-69.6 62.3-129.1 60.9-158.6 48.4s-75-52.5-59.5-86c-7 7-26 40.5-31.5 51.5s-14.5 15.5-19 13.5-9-7.5-5.5-21.5c2.8-11.2 15.2-41 46.9-72.9-15.5 13.3-28.8 27.9-37.4 42.4-25 42-28 66-16 71s28-6 29-13c-2 34 82 67 127 73s140.1-20 179.1-87z" />
                    <path d="M1399 1472c-13 22-56 9-98 14-7.8.9-16.5 3.2-25.5 6.6 33.5-7.4 58.1-2.6 68.5-1.1 13.5 2 48 12 60.5-10 5.8-10.3 7.4-15.2 7.9-18.6zm85.1-5c-3.5-6.9-16.4-31.9-20.1-39l-20.9 12c28 3 36.5 20.6 41 27zM432.7 1242.2c-29.2-21-59.3-40-58.7-56.2 1-28 5-40 5-40s2.6-16.3-7-20c-14 10-14.9 27.1-15.5 35.5-2 28 20 51.5 51 67 7.6 3.8 16.3 8.6 25.2 13.7zm429-862.5s-5.4 3.4-16.3-4.9c-25.1 41.9-46.2 89.3-58.9 140.4 25.1-71.8 63.7-127.3 75.2-135.5z" />
                    <path d="M861.7 379.7s-7.3 4.7-22-10c-11.8-11.8-23.1-32.6-22.6-85.6-4.3 41.7.2 83.9 21.1 119l7.6-5c6.9-9.6 12.5-16 15.9-18.4zM1681 508.3c-13.3 18-22.7 19.3-36 15.3-3.3-1-6.5-2.8-9.5-5.2l29.1 40.7c37.6-27.9 77.5-146.7 78.4-223.4-9.6 68.1-49.4 155.7-62 172.6zm-57-6.3c-.3-2.2-.6-.3-1-3 .1 2.4.4.5 1 3zm-3.1-3.9c-.6-1.5-1-2.9-1.4-4.4.2 1.1.3 2.1.4 3zM801 745l3.9-12.6-2.3-3.7-1.5-1.5c0 2.5-.2 9.3-4 7.1-4.7-2.7-37.3-18-60-22s-71.3 0-84-2.7c-9.8-2.1-17.1-8.9-16-19.8-1.3 2.5-2.3 5.4-2.8 8.7-6.2 37.6 123.2 7.5 166.7 46.5z" />
                  </g>
                  <path
                    d="M812.6 772.1c-19.5-19.5-163.6-48-160.5-3 3 43.5 96-9 159 18 0 0 0-10.5 1.5-15z"
                    fill="#261e2b"
                  />
                  <path
                    d="M812.6 772.1c-1.6-1.6-3.9-3.2-6.9-4.8.9 3.6 1.7 10.2-4 11.7 0 0-14.7-10-45.3-12.7-30.7-2.7-69.3 17.3-88.7 13.3-14.5-3-16.2-12.3-11.2-23.3-3.1 3.4-4.7 7.5-4.4 12.7 3 43.5 96-9 159 18 0 .1 0-10.4 1.5-14.9zM1733 933c-18 6.7-60-22.7-96-39.3-2.6-2.1-4-9.9 1.9-15.1-21.1-2.3-40-2.8-50.8-1.5-4.5-1.5 6 22.5 6 22.5 58.5-4.5 133.5 75 154.5 33 3.8-7.7 2.2-14.6-3.3-20.7 1.6 8.3-.2 16.6-12.3 21.1zm-37.7 54.5c-3.8 4.8-12 6-29 2.1-26-6-38-38.7-58.7-50.7.5-3.5 2.1-10.7 8.5-13.3-10.5-4.5-18.7-7.5-22.1-8.1-15-3-29.6 6.3-19.5 10.5 46.5 19.5 82.5 102 114 73.5 4.9-4.3 7-9.1 6.8-14zm-71.6-507.2c6.7 4.7 23.3-18 30-26.7s26-36.7 31.3-60 6.7-71.3-4-83.3-62.7-5.3-94.7 11.3c-32 16.7-50.7 36-62 35.3s-28-6-30.7-9.3c2 8 26.7 18.7 37.3 20.7s46.7 30 64.7 53.3 22 44 22.7 51.3c.7 7.4 5.4 7.4 5.4 7.4zm-52-214.6c-31.3 10.7-60 24.7-67.3 34.7s-12 23.3-12.7 28.7c0-16.7 15.3-50 7.3-58l15.6 10c17.7-9.4 57.1-15.4 57.1-15.4zm-695.4 98c8-8.7 18-18.7 14.7-30.7s-26-41-17.3-87.3c7.1-38 27.3-92.7 39.3-98.7s48 13 72 35c32.9 30.1 32 61 52.7 69.7s34 11.3 44 7.3c-18 14-46 10.6-61.3 9.3-16-1.3-48.7 15.3-66.7 23.3-17 7.5-34.7 22.7-42.7 37.3s-11.3 25.4-34.7 34.8zm205.4-174c10 14 23.3 34.7 19.3 47.3s-8 20-2 17.3 16-18 34.7-28 79.3-37.3 92-39.3c-8.7-5.3-45.3-5.8-59.3-6.7-30.7-2-84.7 9.4-84.7 9.4z"
                    fill="#19121d"
                  />
                </svg>
              </div>
              <div className="flex-grow text-gray-900 sm:pr-16">
                <h1 className="text-2xl font-bold">GitHub Sponsors</h1>
                <p className="text-lg font-medium text-gray-500 dark:text-gray-400">
              ...
              <button
                className="focus:outline-none w-full flex-none rounded-lg border border-transparent bg-blue-700 py-3 px-6 text-lg font-semibold leading-6 text-white shadow-md transition-colors duration-200 hover:bg-blue-600 hover:shadow-xl focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white sm:w-auto"
                onClick={() => router.push('https://github.com/sponsors/javaistic')}
              >
                Sponsor
              </button>
            </div>
